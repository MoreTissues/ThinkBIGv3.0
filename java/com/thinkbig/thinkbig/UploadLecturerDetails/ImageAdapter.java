...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ImageViewHolder> {
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.lecturer_list_item, parent, false);
    ...
    public void onBindViewHolder(ImageViewHolder holder, int position) {
        ...
        holder.txt_desc.setText(uploadCurrent.getmDesc());
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,
        ...
        public TextView textViewName, txt_desc;
        ...
        public ImageViewHolder(View itemView) {
            ...
            txt_desc = itemView.findViewById(R.id.txt_desc3);
